...
export const checkOverlap = (emp1Start, emp1End, emp2Start, emp2End) => {
    ...
    const endDate1 = emp1End === null || emp1End === 'null' || emp1End === 'NULL' ? new Date() : new Date(emp1End);
    const startDate2 = new Date(emp2Start);
    const endDate2 = emp2End === null || emp2End === 'null' || emp2End === 'NULL' ? new Date() : new Date(emp2End);
